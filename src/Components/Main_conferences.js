    ...
    return (
      ...
      <Container className="my-2">
        ...
        />
          ...
          <Card.Body>
            <Card.Title className="text-center"><a href="" className="nav-link d-inline text-black" target="_blank" rel="noopener noreferrer">Inverse incorrect tasks and machine learning</a></Card.Title>
          </Card.Body>
        </Card>
        </a>
        </Col>
